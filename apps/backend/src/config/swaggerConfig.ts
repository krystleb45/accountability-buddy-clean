...
const servers = [
  ...
  ...(env === "production"
    ? [
        {
          url:
            process.env.API_PROD_URL || "https://api.accountabilitybuddys.com",
  ...
  definition: {
    ...
    info: {
      ...
      contact: {
        name: "API Support",
        email:
          process.env.API_SUPPORT_EMAIL || "support@accountabilitybuddys.com",
        url:
          process.env.SUPPORT_URL || "https://accountabilitybuddys.com/support",
      },
      termsOfService:
        process.env.API_TOS_URL || "https://accountabilitybuddys.com/terms",
      license: {
