...
async function calculateChallengeParticipationRate (userId: string): Promise<number> {
  try {
...
async function getSubscriptionData (userId: string): Promise<Record<string, any>> {
  try {
...
async function trackPremiumFeatureUsage (userId: string): Promise<Record<string, any>> {
  try {
 ...
 */
async function getUserAnalytics (userId: string,  _endDate?: string,  _metric?: string): Promise<Record<string, any> | null> {
  try {
