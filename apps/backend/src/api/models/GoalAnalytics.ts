...
// --- Instance Methods ---
GoalAnalyticsSchema.methods.isStreakActive = function (
  this: IGoalAnalytics,
): boolean {
...
GoalAnalyticsSchema.statics.recordTaskCompletion = async function (
  ...
  analytics.averageTaskCompletionTime =
    (prevAvg * (analytics.completedTasks - 1) + completionTimeHours) /
...
// --- Model Export ---
export const GoalAnalytics = mongoose.model<
  IGoalAnalytics,
  IGoalAnalyticsModel
>("GoalAnalytics", GoalAnalyticsSchema)
