...
const CollaborationGoalSchema = new Schema<
  ICollaborationGoal,
  ICollaborationGoalModel
>(
  {
...
// --- Virtuals ---
CollaborationGoalSchema.virtual("participantCount").get(function (
  this: ICollaborationGoal,
): number {
  return this.participants.length
})
CollaborationGoalSchema.virtual("milestoneCount").get(function (
  this: ICollaborationGoal,
): number {
  return this.milestones.length
})
CollaborationGoalSchema.virtual("completedMilestonesCount").get(function (
  this: ICollaborationGoal,
): number {
...
// --- Model Export ---
export const CollaborationGoal = mongoose.model<
  ICollaborationGoal,
  ICollaborationGoalModel
