...
export const getAllAchievements = catchAsync(
  async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    ...
    sendResponse(res, 200, true, "User achievements retrieved", {
      achievements,
    })
  },
)
...
export const addAchievement = catchAsync(
  async (
    req: Request<unknown, unknown, CreateAchievementDTO>,
    res: Response,
    next: NextFunction,
  ) => {
    ...
    sendResponse(res, 201, true, "Achievement created", {
...
export const updateAchievement = catchAsync(
  async (
    req: Request<{ id: string }, unknown, UpdateAchievementDTO>,
    res: Response,
    next: NextFunction,
  ) => {
    const { id } = req.params
    ...
    sendResponse(res, 200, true, "Achievement updated", {
      achievement: updated,
    })
  },
)
...
export const getLeaderboardAchievements = catchAsync(
  async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    ...
    sendResponse(res, 200, true, "Leaderboard achievements retrieved", {
      achievements,
    })
  },
)
