...
export const getPublicChallenges = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    ...
    sendResponse(res, 200, true, "Public challenges fetched successfully", {
      challenges,
    })
  },
)
...
export const joinChallenge = catchAsync(
  async (
    req: AuthenticatedRequest<any, { challengeId: string }>,
    res: Response,
  ): Promise<void> => {
...
export const fetchChallengesWithPagination = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    ...
    sendResponse(res, 200, true, "Challenges fetched successfully", {
      challenges,
    })
  },
)
...
export const createChallenge = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    ...
    const { name, description, pointsRequired, rewardType, visibility } =
      req.body
