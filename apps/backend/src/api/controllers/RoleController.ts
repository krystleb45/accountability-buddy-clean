...
export async function seedRoles (_req: Request,  res: Response,  next: NextFunction): Promise<void> {
  try {
...
export async function updateRole (req: Request<{ id: string }, {}, { permissions: string[] }>,  res: Response,  next: NextFunction): Promise<void> {
  try {
...
export async function deleteRole (req: Request<{ id: string }>,  res: Response,  next: NextFunction): Promise<void> {
  try {
