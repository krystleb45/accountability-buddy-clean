...
export const pinGoal = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
...
export const unpinGoal = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
    const pinnedGoals = await UserService.unpinGoal(
      req.user!.id,
      req.body.goalId,
    )
...
export const getPinnedGoals = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
...
export const featureAchievement = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
    const featured = await UserService.featureAchievement(
      req.user!.id,
...
export const unfeatureAchievement = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
    const featured = await UserService.unfeatureAchievement(
      req.user!.id,
      req.body.achievementId,
    )
...
export const fetchAllUsers = catchAsync(
...
export const fetchBadges = catchAsync(
  async (_req: AuthenticatedRequest, res: Response) => {
...
export const fetchUserBadges = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
...
export const awardBadge = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
    const badges = await UserService.awardBadge(
      req.body.userId,
      req.body.badgeId,
    )
 ...
 * @access  Private
 */
export const getLastCheckIn = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
 ...
 * @access  Private
 */
export const logCheckIn = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
