...
export const deleteUserAccount = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  await UserService.deleteUser(req.user!.id);
  sendResponse(res, 200, true, "Account deleted successfully");
});

export const getLeaderboard = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
...
export const pinGoal = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  const pinnedGoals = await UserService.pinGoal(req.user!.id, req.body.goalId);
  sendResponse(res, 200, true, "Goal pinned", { pinnedGoals });
});

export const unpinGoal = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
...
export const getPinnedGoals = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  const pinnedGoals = await UserService.getPinnedGoals(req.user!.id);
  sendResponse(res, 200, true, "Pinned goals fetched", { pinnedGoals });
});

export const featureAchievement = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
...
export const unfeatureAchievement = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
...
export const getFeaturedAchievements = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
...
export const fetchAllUsers = catchAsync(async (_req: AuthenticatedRequest, res: Response) => {
...
export const fetchBadges = catchAsync(async (_req: AuthenticatedRequest, res: Response) => {
  const badges = await UserService.fetchBadges();
  sendResponse(res, 200, true, "Badges fetched", { badges });
});

export const fetchUserBadges = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  const badges = await UserService.fetchUserBadges(req.params.userId);
  sendResponse(res, 200, true, "User badges fetched", { badges });
});

export const awardBadge = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  const badges = await UserService.awardBadge(req.body.userId, req.body.badgeId);
  sendResponse(res, 200, true, "Badge awarded", { badges });
});

export const getUserStatistics = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
 ...
 * @access  Private
 */
export const getLastCheckIn = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
 ...
 * @access  Private
 */
export const logCheckIn = catchAsync(async (req: AuthenticatedRequest, res: Response) => {
