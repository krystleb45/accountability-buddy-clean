...
export async function getAllFaqs (_req: Request,  res: Response,  _next: NextFunction): Promise<void> {
  const faqs = await Faq.find().lean().exec();
  sendResponse(res, 200, true, "FAQs retrieved successfully", faqs);
}

export async function getFaqById (req: Request,  res: Response,  _next: NextFunction): Promise<void> {
...
export async function createFaq (req: Request,  res: Response,  _next: NextFunction): Promise<void> {
  const faq = await Faq.create(req.body);
  sendResponse(res, 201, true, "FAQ created successfully", faq);
}

export async function updateFaq (req: Request,  res: Response,  _next: NextFunction): Promise<void> {
...
export async function deleteFaq (req: Request,  res: Response,  _next: NextFunction): Promise<void> {
