...
/**
 * Lean version of BadgeProgressDocument (type alias of `BadgeProgress`)
 *
 * Use this type alias to avoid conflicts with model names:
 * ```
 * import { BadgeProgress } from "../models"
 * import { BadgeProgressObject } from "../interfaces/mongoose.gen.ts"
 *
 * const badgeprogressObject: BadgeProgressObject = badgeprogress.toObject();
 * ```
 */
export type BadgeProgressObject = BadgeProgress
 ...
 * This type is returned from query functions. For most use cases, you should not need to use this type explicitly.
 */
export type BadgeProgressQuery = mongoose.Query<
  any,
  BadgeProgressDocument,
  BadgeProgressQueries
> &
  BadgeProgressQueries
 ...
 * Mongoose Query helper types
 *
 * This type represents `BadgeProgressSchema.query`. For most use cases, you should not need to use this type explicitly.
 */
export type BadgeProgressQueries = {}

export type BadgeProgressMethods = {}

export type BadgeProgressStatics = {}
 ...
 * Pass this type to the Mongoose Model constructor:
 * ```
 * const BadgeProgress = mongoose.model<BadgeProgressDocument, BadgeProgressModel>("BadgeProgress", BadgeProgressSchema);
 * ```
 */
export type BadgeProgressModel = mongoose.Model<
  BadgeProgressDocument,
  BadgeProgressQueries
> &
  BadgeProgressStatics

/**
 * Mongoose Schema type
 *
 * Assign this type to new BadgeProgress schema instances:
 * ```
 * const BadgeProgressSchema: BadgeProgressSchema = new mongoose.Schema({ ... })
 * ```
 */
export type BadgeProgressSchema = mongoose.Schema<
  BadgeProgressDocument,
  BadgeProgressModel,
  BadgeProgressMethods,
  BadgeProgressQueries
>
 ...
 * ```
 */
export type BadgeProgressDocument = mongoose.Document<
  mongoose.Types.ObjectId,
  BadgeProgressQueries
> &
  BadgeProgressMethods & {
...
/**
 * Lean version of GoalAnalyticsDocument (type alias of `GoalAnalytics`)
 *
 * Use this type alias to avoid conflicts with model names:
 * ```
 * import { GoalAnalytics } from "../models"
 * import { GoalAnalyticsObject } from "../interfaces/mongoose.gen.ts"
 *
 * const goalanalyticsObject: GoalAnalyticsObject = goalanalytics.toObject();
 * ```
 */
export type GoalAnalyticsObject = GoalAnalytics
 ...
 * This type is returned from query functions. For most use cases, you should not need to use this type explicitly.
 */
export type GoalAnalyticsQuery = mongoose.Query<
  any,
  GoalAnalyticsDocument,
  GoalAnalyticsQueries
> &
  GoalAnalyticsQueries
 ...
 * Mongoose Query helper types
 *
 * This type represents `GoalAnalyticsSchema.query`. For most use cases, you should not need to use this type explicitly.
 */
export type GoalAnalyticsQueries = {}

export type GoalAnalyticsMethods = {
  isStreakActive: (this: GoalAnalyticsDocument, ...args: any[]) => any
}

export type GoalAnalyticsStatics = {
  updateStreak: (this: GoalAnalyticsModel, ...args: any[]) => any
  recordTaskCompletion: (this: GoalAnalyticsModel, ...args: any[]) => any
}
 ...
 * Pass this type to the Mongoose Model constructor:
 * ```
 * const GoalAnalytics = mongoose.model<GoalAnalyticsDocument, GoalAnalyticsModel>("GoalAnalytics", GoalAnalyticsSchema);
 * ```
 */
export type GoalAnalyticsModel = mongoose.Model<
  GoalAnalyticsDocument,
  GoalAnalyticsQueries
> &
  GoalAnalyticsStatics

/**
 * Mongoose Schema type
 *
 * Assign this type to new GoalAnalytics schema instances:
 * ```
 * const GoalAnalyticsSchema: GoalAnalyticsSchema = new mongoose.Schema({ ... })
 * ```
 */
export type GoalAnalyticsSchema = mongoose.Schema<
  GoalAnalyticsDocument,
  GoalAnalyticsModel,
  GoalAnalyticsMethods,
  GoalAnalyticsQueries
>
 ...
 * ```
 */
export type GoalAnalyticsDocument = mongoose.Document<
  mongoose.Types.ObjectId,
  GoalAnalyticsQueries
> &
  GoalAnalyticsMethods & {
...
/**
 * Lean version of LeaderboardDocument (type alias of `Leaderboard`)
 *
 * Use this type alias to avoid conflicts with model names:
 * ```
 * import { Leaderboard } from "../models"
 * import { LeaderboardObject } from "../interfaces/mongoose.gen.ts"
 *
 * const leaderboardObject: LeaderboardObject = leaderboard.toObject();
 * ```
 */
export type LeaderboardObject = Leaderboard
 ...
 * This type is returned from query functions. For most use cases, you should not need to use this type explicitly.
 */
export type LeaderboardQuery = mongoose.Query<
  any,
  LeaderboardDocument,
  LeaderboardQueries
> &
 ...
 * Mongoose Query helper types
 *
 * This type represents `LeaderboardSchema.query`. For most use cases, you should not need to use this type explicitly.
 */
 ...
 * Pass this type to the Mongoose Model constructor:
 * ```
 * const Leaderboard = mongoose.model<LeaderboardDocument, LeaderboardModel>("Leaderboard", LeaderboardSchema);
 * ```
 */
export type LeaderboardModel = mongoose.Model<
  LeaderboardDocument,
  LeaderboardQueries
> &
  LeaderboardStatics
 ...
 * Mongoose Schema type
 *
 * Assign this type to new Leaderboard schema instances:
 * ```
 * const LeaderboardSchema: LeaderboardSchema = new mongoose.Schema({ ... })
 * ```
 */
export type LeaderboardSchema = mongoose.Schema<
  LeaderboardDocument,
  LeaderboardModel,
  LeaderboardMethods,
  LeaderboardQueries
 ...
 * ```
 */
export type LeaderboardDocument = mongoose.Document<
  mongoose.Types.ObjectId,
  LeaderboardQueries
> &
  LeaderboardMethods & {
...
/**
 * Lean version of ProgressDocument (type alias of `Progress`)
 *
 * Use this type alias to avoid conflicts with model names:
 * ```
 * import { Progress } from "../models"
 * import { ProgressObject } from "../interfaces/mongoose.gen.ts"
 *
 * const progressObject: ProgressObject = progress.toObject();
 * ```
 */
export type ProgressObject = Progress
 ...
 * This type is returned from query functions. For most use cases, you should not need to use this type explicitly.
 */
export type ProgressQuery = mongoose.Query<
  any,
  ProgressDocument,
  ProgressQueries
> &
 ...
 * Mongoose Query helper types
 *
 * This type represents `ProgressSchema.query`. For most use cases, you should not need to use this type explicitly.
 */
export type ProgressQueries = {}

export type ProgressMethods = {}

export type ProgressStatics = {}
 ...
 * Pass this type to the Mongoose Model constructor:
 * ```
 * const Progress = mongoose.model<ProgressDocument, ProgressModel>("Progress", ProgressSchema);
 * ```
 */
export type ProgressModel = mongoose.Model<ProgressDocument, ProgressQueries> &
  ProgressStatics

/**
 * Mongoose Schema type
 *
 * Assign this type to new Progress schema instances:
 * ```
 * const ProgressSchema: ProgressSchema = new mongoose.Schema({ ... })
 * ```
 */
export type ProgressSchema = mongoose.Schema<
  ProgressDocument,
  ProgressModel,
  ProgressMethods,
  ProgressQueries
 ...
 * ```
 */
export type ProgressDocument = mongoose.Document<
  mongoose.Types.ObjectId,
  ProgressQueries
> &
  ProgressMethods & {
...
export type SubscriptionMethods = {
  cancel: (this: SubscriptionDocument, ...args: any[]) => any
  renew: (this: SubscriptionDocument, ...args: any[]) => any
  isTrialActive: (this: SubscriptionDocument, ...args: any[]) => any
}

export type SubscriptionStatics = {
  findByUser: (this: SubscriptionModel, ...args: any[]) => any
  expireSubscriptions: (this: SubscriptionModel, ...args: any[]) => any
}
