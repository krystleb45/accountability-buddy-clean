  ...
  try {
    ...
    const resources = [
      ...
      },
      {
        ...
        description:
          "Offers resources for mental health support for military members.",
      },
    ]
    ...
    const chatrooms = [
      {
        ...
        description:
          "A safe space for military members to share experiences and support each other.",
        isPrivate: false,
      },
      {
        name: "Veteran Affairs Discussion",
        description:
          "A place for military veterans to discuss their transition into civilian life.",
        isPrivate: true,
      },
      {
        name: "Deployment Support",
        description:
          "For those currently deployed or preparing for deployment, to share tips and advice.",
        isPrivate: false,
      },
    ]
