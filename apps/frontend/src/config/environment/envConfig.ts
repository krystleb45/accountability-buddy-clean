...
const envConfig: EnvConfig = {
  ...
  securityHeaders: {
    contentSecurityPolicy: strEnv('NEXT_PUBLIC_CSP', "default-src 'self'; script-src 'self';"),
    xFrameOptions: strEnv('NEXT_PUBLIC_X_FRAME_OPTIONS', 'SAMEORIGIN'),
    strictTransportSecurity: strEnv('NEXT_PUBLIC_HSTS', 'max-age=31536000; includeSubDomains'),
  },
