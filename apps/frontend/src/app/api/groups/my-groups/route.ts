...
export async function GET(_request: NextRequest) {
  try {
    ...
    if (!accessToken) {
      ...
      console.log(
        "🔍 [MY GROUPS PROXY] Available session keys:",
        Object.keys(session),
      )
      console.log(
        "🔍 [MY GROUPS PROXY] Available user keys:",
    ...
    console.log(
      `📥 [MY GROUPS PROXY] Express responded with status: ${response.status}`,
    )
