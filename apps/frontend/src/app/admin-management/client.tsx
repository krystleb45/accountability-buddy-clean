...
import { userHasPermission, PERMISSIONS } from '@/services/roleService';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <header className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Admin Management</h1>
      ...
      {loading ? (
        ...
        <main className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* User Roles */}
          <section className="transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 hover:shadow-xl">
            <h2 className="mb-4 text-2xl font-semibold text-gray-800">User Roles</h2>
            <p className="mb-4 text-gray-600">
              Assign roles and manage user permissions across the platform.
            </p>
            <p className="text-lg font-bold text-gray-700">Total Users: {userCount ?? 'N/A'}</p>
            <button
          ...
          {/* Permissions */}
          <section className="transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 hover:shadow-xl">
            <h2 className="mb-4 text-2xl font-semibold text-gray-800">Permissions</h2>
            <p className="mb-4 text-gray-600">
          ...
          {/* System Settings */}
          <section className="transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 hover:shadow-xl">
            <h2 className="mb-4 text-2xl font-semibold text-gray-800">System Settings</h2>
            <p className="mb-4 text-gray-600">Adjust global configurations for the platform.</p>
            <button
          ...
          {/* Rewards */}
          <section className="transform rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 hover:shadow-xl">
            <h2 className="mb-4 text-2xl font-semibold text-gray-800">Manage Rewards</h2>
            <p className="mb-4 text-gray-600">
