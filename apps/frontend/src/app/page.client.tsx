  ...
  return (
    <section className="bg-gray-900 px-4 py-8">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="mb-3 text-4xl font-bold text-green-400 md:text-5xl">
            Choose Your Path to Success
          </h2>
          <p className="mx-auto mb-6 max-w-3xl text-lg text-gray-300 md:text-xl">
            ...
            >
              {plan.isPopular && (
                ...
                <div className="absolute -top-4 left-1/2 z-10 -translate-x-1/2">
                  <span className="whitespace-nowrap rounded-full bg-green-400 px-4 py-2 text-sm font-bold text-black shadow-lg">
                    Most Popular
                  </span>
                </div>
              )}
              ...
              <div
                className={`mb-6 text-center ${plan.isPopular ? "mt-2" : ""}`}
              >
