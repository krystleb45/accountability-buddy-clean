...
export type ResponseSuccessMessage =
  (typeof RESPONSE_SUCCESS_MESSAGES)[ResponseSuccessKey]
...
export type ResponseErrorMessage =
  (typeof RESPONSE_ERROR_MESSAGES)[ResponseErrorKey]
...
export type ResponseInfoMessage =
  (typeof RESPONSE_INFO_MESSAGES)[ResponseInfoKey]
...
export type ResponseWarningMessage =
  (typeof RESPONSE_WARNING_MESSAGES)[ResponseWarningKey]
