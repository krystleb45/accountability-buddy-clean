...
/** 👉 Pagination settings */
export type ItemsPerPageOptions =
  (typeof UI_CONSTANTS.PAGINATION.ITEMS_PER_PAGE_OPTIONS)[number]
export type DefaultItemsPerPage =
  typeof UI_CONSTANTS.PAGINATION.DEFAULT_ITEMS_PER_PAGE
