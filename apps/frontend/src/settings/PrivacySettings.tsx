...
const PrivacySettings: React.FC = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const stored = localStorage.getItem('profileVisibility') as ProfileVisibility | null;
      if (stored === 'public' || stored === 'friends-only' || stored === 'private') {
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.intro}>Control who can see your profile and personal data.</p>
      ...
      <div className={styles.setting}>
        ...
        >
          ...
          <option value="friends-only">Friends Only – Only your connections</option>
