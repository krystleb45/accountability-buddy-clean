 ...
 */
export const combineClassNames = (...classes: (string | false | null | undefined)[]): string =>
 ...
 */
export const BUTTON_VARIANTS = ['primary', 'secondary', 'danger', 'outline'] as const;
/**
...
export const isValidButtonVariant = (v: string): v is ButtonVariant =>
  (BUTTON_VARIANTS as readonly string[]).includes(v);

/** Type‐guard: is this string a valid ButtonSize? */
export const isValidButtonSize = (s: string): s is ButtonSize =>
  (BUTTON_SIZES as readonly string[]).includes(s);
