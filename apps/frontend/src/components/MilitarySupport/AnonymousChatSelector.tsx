    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50">
        <div className="text-center">
          <Loader2 className="mx-auto mb-4 size-12 animate-spin text-emerald-600" />
      ...
      <div className="min-h-screen bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-8">
          <Link
            ...
            className="mb-6 inline-flex items-center text-slate-600 transition-colors hover:text-slate-800"
          >
    ...
    <div className="bg-slate-50">
      ...
      <div className="border-b border-slate-200 bg-white shadow-sm">
        <div className="mx-auto max-w-6xl px-4 py-6">
          <Link
            href="/military-support"
            className="mb-4 inline-flex items-center text-slate-600 transition-colors hover:text-slate-800"
          >
            <ArrowLeft className="mr-2 size-4" />
            Back to Military Support
          </Link>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 pb-8">
        ...
        <div className="mb-6 grid gap-6 md:grid-cols-3">
          {rooms.map((room) => (
            ...
            >
              <div className="h-full rounded-lg border border-slate-200 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-lg">
                ...
                <div className="space-y-3 text-center">
                  ...
                  {/* Action Button */}
                  <div className="pt-2">
                    <div className="rounded-full bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-700 transition-colors group-hover:bg-emerald-100">
                      Join Chat
                    </div>
                  </div>
                </div>
