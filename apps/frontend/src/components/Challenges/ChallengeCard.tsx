...
import { Challenge } from '@/api/challenge/challengeApi';
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex flex-col sm:mb-0 sm:flex-row sm:items-center sm:space-x-4">
        <div className="creator-info mb-2 flex items-center gap-3 sm:mb-0">
          <img
            ...
            className="creator-avatar h-8 w-8 rounded-full"
          />
          <span className="creator-name text-sm text-white sm:text-base">@{creator.username}</span>
        </div>
        <span
      ...
      <div className="flex-1">
        ...
        <p className="challenge-goal mb-2 text-sm text-gray-400 sm:text-base">🎯 Goal: {goal}</p>
