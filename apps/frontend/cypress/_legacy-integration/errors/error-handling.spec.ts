...
describe('Error Handling', () => {
  ...
  it('displays a network error message when API call fails', () => {
    ...
    cy.contains('We are experiencing issues. Please try again later.').should('be.visible');
  });
  ...
  it('displays a friendly message for network disconnection', () => {
    ...
    cy.contains('Please check your internet connection and try again.').should('be.visible');
  });
});
