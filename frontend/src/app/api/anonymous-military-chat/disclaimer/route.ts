...
export async function GET(_request: NextRequest) {
  try {
    console.log('[PROXY] Military Support Disclaimer - Forwarding to:', `${BACKEND_URL}/api/military-support/disclaimer`);

    const response = await fetch(`${BACKEND_URL}/api/military-support/disclaimer`, {
      method: 'GET',
      headers: {
    ...
    console.log('[PROXY] Military Support Disclaimer - Response status:', response.status);
