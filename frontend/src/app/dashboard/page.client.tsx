...
import { fetchUserStreak, type StreakData } from '../../api/goal/goalsApi';
import { fetchDashboardStats, type DashboardStats } from '@/api/dashboard/dashboardApi';
...
export default function DashboardClient() {
  ...
  if (status !== 'authenticated' || error || !streakData || !userProgress || !stats) {
    return (
