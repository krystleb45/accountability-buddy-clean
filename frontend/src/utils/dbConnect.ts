...
// 1) If you haven’t yet installed @types/mongoose, this @ts-ignore will suppress the missing-module/type error.
//    Once you run `npm install mongoose @types/mongoose`, you can safely remove the next line.
// @ts-ignore
