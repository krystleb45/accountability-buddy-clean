...
interface LogConfig {
  ...
  setUserContext(this: LogConfig, user: { id?: string; email?: string; username?: string }): void;
...
const logConfig: LogConfig = {
  ...
  sentryEnabled: process.env.NODE_ENV === 'production' && !!process.env.REACT_APP_SENTRY_DSN,

  // LogRocket Configuration
  logRocketAppId: process.env.REACT_APP_LOGROCKET_APP_ID || '',
  logRocketEnabled:
    process.env.NODE_ENV === 'production' && !!process.env.REACT_APP_LOGROCKET_APP_ID,

  // Enable/Disable Console Logging
  enableLogging:
    process.env.REACT_APP_ENABLE_LOGGING === 'true' || process.env.NODE_ENV === 'development',
